...
# Test cases
# ----------------------------------------------------------
def test_open_bottom_film_tab(device, hierarchy_viewer):
...
def test_open_bottom_tv_tab(device, hierarchy_viewer):
...
def test_open_bottom_children_tab(device, hierarchy_viewer):
