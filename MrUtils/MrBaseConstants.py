...
def init_g_path_vars(g_run_num):
    ...
    g_mr_log_sub_dir_path_for_win = r'%s\mr_logs_%s_%s' %(g_mr_log_root_dir_path_for_win, g_cur_date, g_run_num)
    g_mr_log_file_path_for_win = os.path.join(g_mr_log_sub_dir_path_for_win, ('mr_log_%s_%s.log' %(g_cur_date, g_run_num)))
    ...
    g_mr_log_sub_dir_path_for_shell = '%s/mr_logs_%s_%s' %(g_mr_log_root_dir_path_for_shell, g_cur_date, g_run_num)
    g_captures_dir_path_for_shell = '%s/captures' %(g_mr_log_sub_dir_path_for_shell)
    g_logcat_file_path_for_shell = '%s/mr_logcat_%s_%s.log' %(g_mr_log_sub_dir_path_for_shell, g_run_num, g_cur_date)
